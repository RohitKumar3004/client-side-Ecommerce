...
import {AiOutlineMail,AiOutlineInstagram,AiOutlineFacebook,AiOutlineTwitter} from 'react-icons/ai'
import './Footer.scss'
import creditCardImg from '../../assets/payment.jpg'
function Footer() {
  return (
    <footer className='Footer'>
      <div className="container">
        ...
        <div className="subfooter center">
          <div className="credit-car-img">
            <img src={creditCardImg} alt="credit card img" />
          </div>
          <p>Copyright {new Date().getFullYear()}© <strong>Postrez.</strong> </p>
        </div>
      </div>
    </footer>
  )
